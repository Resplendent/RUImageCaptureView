...
// RUImageCaptureView
#define COCOAPODS_POD_AVAILABLE_RUImageCaptureView
#define COCOAPODS_VERSION_MAJOR_RUImageCaptureView 0
#define COCOAPODS_VERSION_MINOR_RUImageCaptureView 1
#define COCOAPODS_VERSION_PATCH_RUImageCaptureView 0
